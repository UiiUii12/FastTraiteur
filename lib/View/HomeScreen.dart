...
class HomeScreen extends StatelessWidget {
                                  ...
                                  Container(
                                    ...
                                    child: TextField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          hintText: 'Chercher un restaurant, plat',
                                          hintStyle: TextStyle(
                                          ...
                                          children: [
                                                                ...
                                                                Row(
                                                                  children: [
                                                                    ...
                                                                    SizedBox(
                                                                      width: 17.w,),
                                                                    index <
                                                                        controller.restaurants.length - 1
                                                                        ? Restaurant(
                                                                        controller.restaurants[index +
                                                                            1].nom,
                                                    ...
                                                    GetX<HomeController>(
                                                      builder: (controller) {
                                                        return ListView(
                                                          children :[
                                                            ...List.generate(controller.plat("pizza").length, (index) => (index % 2 ==0) ?  Column(
                                                              children: [
                                                                Row(
                                                                  children: [
                                                                    SizedBox(width :22.w),
                                                                    Plat(controller.plats[index].nom , controller.plats[index].description , controller.plats[index].categorie , controller.plats[index].prix ) ,
                                                                    SizedBox(width: 17.w,),
                                                                    index< controller.plats.length-1  ? Plat(controller.plats[index+1].nom , controller.plats[index+1].description , controller.plats[index+1].categorie , controller.plats[index+1].prix ):Container(),
                                                                    SizedBox(width :22.w),
  ...
  Widget Plat ( String nom , String description ,  String  categorie, double prix){
    return Container(
      height:225.h ,
      width: 149.w,
      decoration: BoxDecoration(
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            width: 141.w,
            decoration: BoxDecoration(
              image: DecorationImage(image: AssetImage("Asset/Images/burger4.jpg") , fit: BoxFit.cover),
              borderRadius: BorderRadius.circular(16.r),
